...
if verbose >= 3:
    vlc_verbose = 2
vlc_cmd=f'/usr/bin/cvlc -f --intf rc --x11-display :0 -A alsa --alsa-audio-channels 6 --drm-vout-source-modeset --drm-vout-display HDMI-A-1 --no-video-title-show --no-osd --no-spu --rc-host 127.0.0.1:44500 --verbose {vlc_verbose}'
