...
verbose = 5
vlc_cmd='/usr/bin/vlc -f --intf rc --x11-display :0 -A alsa --alsa-audio-channels 6 --drm-vout-source-modeset --drm-vout-display HDMI-A-1 --no-video-title-show --no-osd --no-spu --rc-host 127.0.0.1:44500'
